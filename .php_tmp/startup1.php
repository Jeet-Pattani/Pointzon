...
<body>
  ...
  <div class="main-news-container">
    ...
    <div class="news-image">
      <div class="news-img-wrapper"><img
          src="https://cdn.dribbble.com/users/2988193/screenshots/15485200/greenleaf_logo_mark-01_4x.jpg" alt="" />
      </div>
    </div>
    <div class="news-body">
      ...
      <p>GreenLeaf is a sustainable agriculture startup that aims to revolutionize the way we grow our food. Our
        innovative approach combines traditional farming techniques with cutting-edge technology to create a more
        efficient, environmentally friendly, and cost-effective system.</p>
      <p>
      <ul>
  ...
  <div class="fullText">
    ...
    <p>Our goal is to raise £10,000 to further develop and expand our operations, allowing us to bring our sustainable
      farming methods to more communities. Our team of experienced farmers and agronomists has spent years researching
      and perfecting our approach, and we're now ready to take it to the next level. The funds we raise will be used to
      purchase equipment, hire additional staff, and expand our reach to more farmers and communities.
    </p>
    <p>By investing in GreenLeaf, you're not just supporting a business, you're supporting a movement towards a more
      sustainable future. With your help, we can make a real impact on the environment, economy, and communities we
      serve. Together, we can build a better, greener world.
    </p>
  </div>
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of GreenLeaf as a short-term investment option is based on the company's strong
