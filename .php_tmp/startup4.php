...
<body>
  ...
  <div class="news-image">
      <div class="news-img-wrapper"><img src="https://www.shutterstock.com/image-vector/smart-house-logo-home-icon-260nw-1489239686.jpg" alt="" /></div>
    </div>
    <div class="news-body">
      <div class="news-heading">
        <h2>SmartHome</h2>
      </div>
      <p>Our platform, SmartHome, offers a revolutionary solution to home automation. With the touch of a button, control lighting, temperature, security, and more from your smartphone or voice-enabled device. Our cutting-edge technology seamlessly integrates with existing systems and can be customized to fit your individual needs.</p>
      <p>
      <ul>
        <p><i class="fa-solid fa-globe"></i> <a href="https://www.smarthome.com">https://www.smarthome.com</a></p>
        <p> <i class="fa-solid fa-phone-volume"></i> <a href="tel:+451234567890">+44 12345 67890</a></p>
        <p> <i class="fa-solid fa-envelope"></i> <a href="mailto: info@smarthome.com">info@smarthome.com</a></p>
      </ul>
      </p>
    </div>
  </div>
  <div class="fullText">
  <p class="tagline">Introducing SmartHome - "Effortless Living, Smartly Controlled"</p>
  <p>Invest in SmartHome and experience the convenience and energy efficiency of a truly connected home. With your support, we can bring this game-changing technology to homes across the globe and make life just a little bit easier for everyone. "Upgrade your home, upgrade your life with SmartHome"
      </p>
  </div>
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of SmartHome as a short-term investment option is based on the company's strong
        ...
        SmartHome's current financials and market trends indicate that the company has the potential to deliver good
