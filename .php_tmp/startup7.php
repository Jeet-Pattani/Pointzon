...
<body>
  ...
  <div class="main-news-container">
    ...
    <div class="news-image">
      <div class="news-img-wrapper"><img
          src="https://images.squarespace-cdn.com/content/v1/631ba951486ec37a86e242c8/0d4ac367-3de9-426c-9a89-f6e03e869ce1/clean_wave_logo_seal-01.png" alt="" />
      </div>
    </div>
    <div class="news-body">
      ...
      <p>CleanWave is revolutionizing the way we think about clean energy. Our innovative technology harnesses the power of ocean waves to generate sustainable electricity for homes and businesses. With CleanWave, you can reduce your carbon footprint and save money on energy costs.</p>
      <p>
      <ul>
        <p><i class="fa-solid fa-globe"></i> <a href="https://www.cleanwave.com">https://www.cleanwave.com</a></p>
        <p> <i class="fa-solid fa-phone-volume"></i> <a href="tel:+441234567890">+44 12345 67890</a></p>
        <p> <i class="fa-solid fa-envelope"></i> <a href="mailto: info@cleanwave.com">info@cleanwave.com</a></p>
      </ul>
      </p>
    </div>
  </div>
  <div class="fullText">
  <p class="tagline">Riding the waves of change with CleanWave</p>
      
      <p>Our patented wave energy converter uses the natural motion of ocean waves to drive a turbine and generate electricity. This technology is not only environmentally friendly, but it is also cost-effective and reliable. Not only that but it also helps to reduce the dependence on fossil fuels and promote the use of renewable energy.
      </p>
      <p>Join the CleanWave movement and help us create a cleaner, greener future for all. Our goal is to make wave energy accessible to communities around the world, and with your support, we can make it happen.</p>
  ...
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of CleanWave as a mid-term investment option is based on the company's strong
        ...
        CleanWave's current financials and market trends indicate that the company has the potential to deliver good
