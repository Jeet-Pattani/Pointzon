...
<body>
  ...
  <div class="news-image">
      <div class="news-img-wrapper"><img src="https://cdn.freebiesupply.com/logos/large/2x/ecopack-logo-svg-vector.svg" alt="" /></div>
    </div>
    <div class="news-body">
    ...
    <p>EcoPack is revolutionizing the packaging industry with our sustainable, eco-friendly solutions. Our mission is to reduce plastic waste and promote a greener future for all. With our innovative technology, we're able to create packaging materials that are not only biodegradable but also stronger and more durable than traditional options.</p>
      <ul>
      <p>
      <ul>
        <p><i class="fa-solid fa-globe"></i> <a href="https://www.ecopack.com">https://www.ecopack.com</a></p>
        <p> <i class="fa-solid fa-phone-volume"></i> <a href="tel:+451234567890">+44 12345 67890</a></p>
        <p> <i class="fa-solid fa-envelope"></i> <a href="mailto: info@ecopack.com">info@ecopack.com</a></p>
      </ul>
      </p>
    </div>
  </div>
  ...
  <p class="tagline">Making a difference, one pack at a time.</p>
      <p>Our team of experts has a passion for protecting the environment and is dedicated to finding new ways to reduce waste. By investing in EcoPack, you're not only supporting a revolutionary business but also making a positive impact on the planet.
      </p>
  </div>
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of EcoPack as a long-term investment option is based on the company's strong
        ...
        EcoPack's current financials and market trends indicate that the company has the potential to deliver good
