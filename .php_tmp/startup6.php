...
<body>
  ...
  <div class="news-image">
      <div class="news-img-wrapper"><img src="https://logos-world.net/wp-content/uploads/2021/07/Shelter-New-Logo.png" alt="" /></div>
    </div>
    <div class="news-body">
    ...
    <p>Are you tired of the housing crisis and skyrocketing rents? Look no further than Shelter, the innovative solution for affordable housing. Our goal is to provide safe, comfortable homes for all, regardless of income level.</p>
    <p>
      <ul>
        <p><i class="fa-solid fa-globe"></i> <a href="https://www.shelter.co.uk">https://www.shelter.co.uk</a></p>
        <p> <i class="fa-solid fa-phone-volume"></i> <a href="tel:+451234567890">+44 12345 67890</a></p>
        <p> <i class="fa-solid fa-envelope"></i> <a href="mailto: info@shelter.co.uk">chat@shelter.co.uk</a></p>
      </ul>
      </p>
    </div>
  </div>
  <div class="fullText">
  <p class="tagline">Shelter: A Place for Every Home</p>
      <p> By working with local governments and community organizations, we are able to secure funding and resources to build sustainable, energy-efficient homes at a fraction of the cost. Not only do we provide homes, but we also offer support services such as financial counseling and job training to help our residents succeed.
      </p>
      <p>With Shelter, everyone has a place to call home. Join us in our mission to end homelessness and create a brighter future for all.
  ...
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of Shelter as a long-term investment option is based on the company's strong
        ...
        Shelter's current financials and market trends indicate that the company has the potential to deliver good
