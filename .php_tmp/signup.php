        ...
        <div class="container-login">
            ...
            <div class="cardContainer">
                <div class="card">
                    ...
                    <a href="businessRegis" class="card-footer-link">Business Signup <i class="fa-solid fa-arrow-right"></i></a>
                </div>
                <div class="card">
                    <h2><strong>Individual Investor</strong></h2>
                    <p>Looking to invest into businesses with potential</p>
                    <a href="investorRegis" class="card-footer-link">Investor Signup <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
