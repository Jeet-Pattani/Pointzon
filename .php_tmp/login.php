...
<?php
    ...
    <div class="Main-container">
        <div class="container-login">
            <h1 style="text-align: center;">Select Your Portal</h1>
            <div class="cardContainer">
                <div class="card">
                    <h2><strong>Individual Business</strong></h2>
                    <p>Looking for fundraising for my business</p>
                    <a href="businessLogin" class="card-footer-link">Business Login <i class="fa-solid fa-arrow-right"></i></a>
                </div>
                <div class="card">
                    <h2><strong>Individual Investor</strong></h2>
                    <p>Looking to invest into businesses with potential</p>
                    <a href="investorLogin" class="card-footer-link">Investor Login <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
