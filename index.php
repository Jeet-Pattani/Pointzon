...
<body>
  ...
  ?>
  <div class=hero>
    <video autoplay loop muted plays-inline id="hero-video" class="bg-video lozad" style="object-fit:cover;height:100vh;width:100vw;" data-poster="videos/hero-poster-2.webp">
      <source data-src="videos/hero2.mp4" type="video/mp4">
    </video>
    <p class="sample-text lozad">Pointzon</p>
    <div class=sub-text>
      <p>Elevate Your Business to the <span style=color:#5349ff>Next Level</span> with Us</p>
    </div>
      ...
      <div class=aboutContainer>
        ...
        <div class=right id=aboutRight data-aos=fade-left data-aos-offset=200 data-aos-easing=ease-in-sine>
          <div class=content>
            ...
            <p>Fundraising can be a daunting task for businesses. That's why we've created a platform that connects you, with potential investors to secure the funding you need to grow. Simplify your fundraising journey with Pointzon.</p>
  ...
  <div class="testimonials">
    ...
    <div class="swiffy-slider slider-indicators-highlight slider-nav-touch slider-nav-autoplay slider-nav-autopause slider-indicators-sm slider-nav-animation slider-item-show2 slider-nav-animation-appear slider-nav-dark slider-nav-sm" data-slider-nav-autoplay-interval=4000>
      <ul class=slider-container>
        <li>
  ...
  <div class="welcome-section content-hidden">
    <div class=content-wrap>
      <ul class=fly-in-text>
        <li>Welcome To The <span style=color:#0d00ff>Future</span></li>
      </ul>
    </div>
  </div>
          ...
          <div class=row>
            <div class="col-md-4 mb-md-0 mb-4">
              ...
              <ul class=list-unstyled>
                <li><a href=resources/terms class=d-block>News</a></li>
                <li><a href=resources/faq class=d-block>FAQs</a></li>
  ...
  <script>
    ...
    const heroSection = document.querySelector(".nav-line");
    if (screen.width > 767) {
