...
<body>
  ...
  $pid = $_GET['id'];
  $cardQuery = "SELECT * FROM projects WHERE id = $pid";
  ...
  <div class="main-news-container">
    ...
    <div class="news-body">
      ...
      <p>
      <ul>
        <p> <i class="fa-solid fa-chart-pie"></i> <a href="<?=$card['b_percent']?>"><?=$card['b_percent']?></a></p>
      </ul>
      </p>
    </div>
  </div>
  ...
  <h4 style="text-align:center"><a href="contact">Contact Our Executive to Invest in <?=$card['b_name']?></a></h4>
  <br><br>
