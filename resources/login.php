        ...
        <div class="container-login">
            ...
            <div class="cardContainer">
                <div class="card">
                    ...
                    <a href="business/businessLogin" class="card-footer-link">Business Login <i class="fa-solid fa-arrow-right"></i></a>
                </div>
                <div class="card">
                    <h2><strong>Investor</strong></h2>
                    <p>Looking to invest into businesses with potential</p>
                    <a href="investor/investorLogin" class="card-footer-link">Investor Login <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
