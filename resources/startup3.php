...
<body>
  ...
  <div class="news-image">
      <div class="news-img-wrapper"><img src="https://thumbs.dreamstime.com/b/discussion-solution-logo-design-vector-template-consultant-company-sign-icon-information-lightbulb-tech-symbol-geometric-168953677.jpg" alt="" /></div>
    </div>
    <div class="news-body">
    ...
    <p>Are you tired of seeing the same old solutions for the same old problems? Look no further than SOLVE IT, the premier destination for innovative solutions to real-world problems. Our team of expert problem-solvers are dedicated to developing unique, cutting-edge solutions to the issues that matter most. Whether it's improving access to education, reducing waste, or increasing sustainability, we've got you covered.</p>
    <p>
      <ul>
        <p><i class="fa-solid fa-globe"></i> <a href="https://www.solveit.com">https://www.solveit.com</a></p>
        <p> <i class="fa-solid fa-phone-volume"></i> <a href="tel:+441234567890">+44 12345 67890</a></p>
        <p> <i class="fa-solid fa-envelope"></i> <a href="mailto: info@solveit.com">info@solveit.com</a></p>
      </ul>
      </p>
    </div>
  </div>
  ...
  <p class="tagline">SOLVE IT: Where Innovation Meets Solutions</p>
  
      <p>But we don't just stop at solutions - we also provide the resources and support to bring these ideas to life. From funding to mentorship, we've got the resources to turn your innovative solution into a reality. And with our commitment to social impact, you can rest assured that your solution will not only be effective, but also make a positive impact on the world.
      </p>
      <p>Join the SOLVE IT community and be a part of the solution. Let's work together to make the world a better place.
  ...
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of Solve IT as a long-term investment option is based on the company's strong
