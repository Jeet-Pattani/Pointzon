    ...
    <div class="Main-container">
        <div class="container-login">
            <div class="wrap-login">
                ...
                $get_all_query = "select * from investor_accounts where email ='$session_email'";
                ...
                <form class="login-form" method="post" action="update.php">
                    ...
                    <div class="text-center p-t-2">
                        <a href="investor-dashboard" class="txt2">Back to Dashboard <i class="fa fa-long-arrow-right " aria-hidden="true"></i></a>
                        <br>
