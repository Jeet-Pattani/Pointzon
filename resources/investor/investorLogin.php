...
if(isset($_POST['submit'])){
    ...
    $emailquery = "SELECT * FROM investor_accounts WHERE email ='$email'";
    ...
    if ($email_count){
        ...
        if($pass_matching){
            ...
            $_SESSION["investorloggedin"] = true;
            $_SESSION["businessloggedin"] = false;
            $_SESSION["email"] = $email;
            //Redirect user to create campaign page
            header("location: investor-dashboard");
        }else{
            $passwordError = "Incorrect Password";
        }
    }else{
        $emailError = "Incorrect Email. User Does Not Exist !";
    }
}
?>
...
<head>
    ...
    <title>Investor Login | Pointzon</title>
        ...
        <div class="container-login">
            <div class="wrap-login">
                ...
                <form class="login-form" method="post">
                    <span class="login-form-title">Investor Login</span>
                    ...
                    <div class="wrap-input">
                        <input type="text" class="input" value="<?php if(isset($email)){echo $email;}?>" name="email" placeholder="Email" required>
