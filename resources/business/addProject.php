...
if(isset($_POST['submit'])){
    ...
    $b_percent = mysqli_real_escape_string($con, $_POST['b_percent']);
    $blogo = $_FILES['blogo'];
    ...
    if($fileerror == 0){
     ...
     $insertquery = "INSERT INTO `projects`(`b_name`, `b_funding`, `b_time`, `b_type`, `b_percent`, `b_logo`, `b_intro`,`b_email`, `b_phoneno`, `b_website`, `b_tagline`, `b_pitch`, `u_email`) VALUES ('$bname','$bfund','$bdays','$btype', '$b_percent', '$destfile ', '$bintro', '$bemail', ' $bphoneno', '$bwebsite', '$btagline', '$bpitch', '$u_email')";

     $iquery = mysqli_query($con,$insertquery);
     if($iquery){
        $status = "Projects Details Added Successfully !";
     }else{
...
<head>
    ...
    <title>Add Project | Pointzon</title>
...
<body>
            ...
            <div id="fh5co-contact" class="animate-box">
                <div class="container" style="width: 80%;">
                    <div class="desc animate-box">
                        <h2 style="color: var(--stark);">Welcome <?php echo $name; ?> ! <br><br> You can Add your Project by filling below details!</h2>
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <select name="btype" style="width:100%;padding: 1rem;" id="btype" onchange="equityCheck(this);">
                                                    <option value="none" selected hidden disabled>Please Choose...</option>
                                        ...
                                        <div class="col-md-6" id="equity_percent" style="display:none;">
                                            <div class="form-group">
                                                <input type="text" inputmode="numeric" name="b_percent" class="form-control" placeholder="Business Equity">
                                            </div>
                                        </div>
    ...
    <script>
        function equityCheck(that){
          
            if (that.value == "Debt" || that.value == "Equity" || that.value == "Donation" || that.value == "Rewards") 
    {
        document.getElementById("equity_percent").style.display = "block";
        console.log(that.value);
    }
    else
    {
        document.getElementById("equity_percent").style.display = "none";
    }
        }
    </script>
