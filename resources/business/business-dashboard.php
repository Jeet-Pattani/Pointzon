...
<body>
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div id="fh5co-contact" class="animate-box">
				<div class="container">
					<div class="desc animate-box">
						<h2 style="color: var(--stark);">Your Approved Projects</h2>
						<br><br>
							...
							<div class=glide>
								<div class=glide__track data-glide-el=track>
									<div class=glide__slides>
										<?php
										$cardQuery = "SELECT * FROM projects WHERE u_email = '$u_email' AND approval=1";
			...
			<div class="container">
				<div class="desc animate-box">
					<h2 style="color: var(--stark);">Your Unapproved Projects</h2>
					<br><br>
					<!-- <h4 style="color: var(--stark);">You have no Campaigns Running as of now&nbsp;<a href="addCampaign" style="text-decoration:underline;">Create a Campaign Now ! </a></h4> -->
					<section class=campaignCards>
						<div class=glide1>
							<div class=glide__track data-glide-el=track>
								<div class=glide__slides>
									<?php
									$cardQuery = "SELECT * FROM projects WHERE u_email = '$u_email' AND approval=0";
									$execQuery = mysqli_query($con, $cardQuery);
									while ($card = mysqli_fetch_assoc($execQuery)) {
									?>
										<div class=cardDemo>
											<a>
												...
												<div class=cardDemoBody>
													...
													<p class=name><?= $card['b_name'] ?></p>
													<p>
													<p class=truncatePara><?= $card['b_intro'] ?></p><a>Know More</a></p>
												</div>
												<div class=cardDemoFooter>
													<p>TARGET: <?= $card['b_funding'] ?> £</p>
													<div class=progress role=progressbar aria-label="Example with label" aria-valuenow=25 aria-valuemin=0 aria-valuemax=100>
