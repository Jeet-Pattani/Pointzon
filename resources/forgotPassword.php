...
<head>
    ...
    <title>Forgot Password? | Pointzon</title>
    ...
    <div class="Main-container">
        <div class="container-login">
            <div class="wrap-login">
                ...
                <div class="login-pic">
                    <img src="images/forgotPassword.svg" alt="IMG">
                </div>
                ...
                <form class="login-form">
                  ...
                  <div class="text-center p-t-2">
                      <a href="signup" class="txt2">Login into your account <i class="fa fa-long-arrow-right " aria-hidden="true"></i></a>
                      <br>
