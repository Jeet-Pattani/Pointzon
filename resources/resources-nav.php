...
<nav class="navbarMain">
            ...
            <ul class="nav-links">
                ...
                <li class="dropdownMenu" id="nav-item-3">
                    ...
                    <h4 class="label"><a href="services">Services</a></h4>
                        <div class="content">
                ...
                if (isset($_SESSION['loggedin'])) {
                    ...
                    <div class="dropdown-content">'?>
                      <?php if ($_SESSION['investorloggedin']==true) {
                                           echo '<a href="investor/investor-dashboard">Dashboard</a>
                                           <a href="investor/editDetails">Edit Your Details</a>
                                           <a href="investor/changePass">Change Password</a>
                        ...
                        {
                          echo '<a href="business/business-dashboard">Dashboard</a>
                          <a href="business/editDetails">Edit Your Details</a>
                          <a href="business/changePass">Change Password</a>
                            <a href="logout">Logout</a>
                          </div>
                        </div>';
     }  else{
      if($_SESSION["adminloggedin"] = true){
        echo '<a href="../admin/admin-dashboard">Admin Dashboard</a>
          <a href="logout">Logout</a>
        </div>
      </div>';
      }
