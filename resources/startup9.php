  ...
  <div class="main-news-container">
    ...
    <div class="news-image">
      <div class="news-img-wrapper"><img
          src="https://img.freepik.com/free-vector/food-shopping-logo-template-design_460848-10299.jpg?w=2000" alt="" />
      </div>
    </div>
    <div class="news-body">
      ...
      <p>Farm2Table is an innovative start-up that aims to revolutionize the way we think about food. Our mission is to connect consumers with local farmers, and to provide fresh, healthy produce straight from the farm to your table.</p>
      <p>
      <ul>
        <p><i class="fa-solid fa-globe"></i> <a href="https://www.farm2table.com">https://www.farm2table.com</a></p>
        <p> <i class="fa-solid fa-phone-volume"></i> <a href="tel:+451234567890">+44 12345 67890</a></p>
        <p> <i class="fa-solid fa-envelope"></i> <a href="mailto: info@farm2table.com">info@farm2table.com</a></p>
      </ul>
      </p>
    </div>
  </div>
  <div class="fullText">
  <p class="tagline">Farm-fresh produce, straight from the source</p>

<p>Our platform allows you to order your produce online and have it delivered to your door on a weekly basis. We work closely with small-scale farmers in your area to ensure that the produce you receive is not only fresh but also sustainably grown. By cutting out the middleman, we are able to offer our customers high-quality, seasonal produce at an affordable price.
</p>
<p>At Farm2Table, we believe that every person should have access to fresh, healthy food, regardless of where they live. By supporting our platform, you are not only investing in your own health but also in the health and wellbeing of your community. Join the farm-to-table movement with Farm2Table and taste the difference!
  ...
  <div class="chartWrapper">
    ...
    <div class="textContainer" id="chartCont1">
      ...
      <p>Pointzon's recommendation of Farm2Table as a short-term investment option is based on the company's strong
        ...
        Farm2Table's current financials and market trends indicate that the company has the potential to deliver good
