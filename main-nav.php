      ...
      if($_SESSION["adminloggedin"] = true){
        echo '<a href="admin/admin-dashboard">Admin Dashboard</a>
          <a href="resources/logout">Logout</a>
                    ...
                    echo '<a  id="nav-item-8" class="login-button" href="resources/login" role="button">Login</a>';
                    echo '<a  id="nav-item-9" class="join-button" href="resources/signup" role="button">Join</a>';
                }
                ?>
            </ul>
        </nav>
